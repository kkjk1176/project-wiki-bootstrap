...
| ${workspace_1.today} | Inject only \`startup.md\` and \`index.md\` through Codex, Claude Code, and Cursor startup hooks, and route Gemini through compact context instructions; route detailed files Read On Demand. | Full canonical and decision bodies waste startup tokens. | Always read detailed canonical and decision files first. | Important context is repeatedly missed at startup. | [[startup]], [[index]] |
