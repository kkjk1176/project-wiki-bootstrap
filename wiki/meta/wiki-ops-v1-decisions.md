...
| 2026-06-10 | Add Cursor and Gemini instruction surfaces, and use Cursor hooks when available. | Cursor can consume both project rules and project hooks; Gemini consumes project context through `GEMINI.md` imports. | Copy the full wiki-first contract separately into every agent-specific file. | Gemini adds a project hook surface or Cursor changes project hook/rule support. | [[startup]], [[index]] |
