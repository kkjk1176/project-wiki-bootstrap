...
| `.codex/`、`.claude/`、`.cursor/` hook | 全 wiki をロードしない Codex/Claude Code/Cursor 起動コンテキスト。 |
...
`install-skill` は再利用可能な skill ファイルだけをコピーします。`AGENTS.md`、`CLAUDE.md`、`GEMINI.md`、`wiki/`、`.cursor/rules/`、`.cursor/hooks.json`、`.codex/hooks.json`、`.claude/settings.json` は作成または更新しません。
